...
const SYSTEM_PROMPTS = {
  ...
  pdf: "You turn PDF files into text.",
    ...
    messages: [
      {
        ...
        content: [
          ...
          {
            type: "text",
            text: "Extract the text form PDF the PDF and print it without explaining you'll do so.",
          },
        ],
      },
    ],
      ...
      messages: [
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              text: "Extract the text form the file and print it in markdown format without explaining you'll do so.",
            },
          ],
        },
      ],
