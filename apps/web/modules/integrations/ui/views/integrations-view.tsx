  ...
  return (
    <>
      <IntegrationsDialog
        ...
        // snippet={`<script src="https://cdn.jsdelivr.net/gh/sakshamtulani/echo@latest/apps/widget/dist/widget.js" data-organization-id="${organization?.id}"></script>`}
      />
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Follow the steps below to integrate Echo with your website
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-6">
          <div className="space-y-2">
